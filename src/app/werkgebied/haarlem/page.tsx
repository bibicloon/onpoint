...
export default function HaarlemPage() {
  return (
    <main>
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({ "@context": "https://schema.org", "@type": "CourierService", "name": "OnPoint Koeriers Haarlem", "image": "https://onpointkoerier.nl/logo.png", "url": "https://onpointkoerier.nl/werkgebied/haarlem", "telephone": "0630037257", "areaServed": { "@type": "City", "name": "Haarlem" } }) }} />
      {/* SECTIE 1 - HERO */}
