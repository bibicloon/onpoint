...
export default function SchipholPage() {
  return (
    <main>
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({ "@context": "https://schema.org", "@type": "CourierService", "name": "OnPoint Koeriers Schiphol", "image": "https://onpointkoerier.nl/logo.png", "url": "https://onpointkoerier.nl/werkgebied/schiphol", "telephone": "0630037257", "areaServed": { "@type": "City", "name": "Schiphol" } }) }} />
      {/* SECTIE 1 - HERO */}
