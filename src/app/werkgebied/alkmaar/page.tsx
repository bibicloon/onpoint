...
export default function AlkmaarPage() {
  return (
    <main>
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({ "@context": "https://schema.org", "@type": "CourierService", "name": "OnPoint Koeriers Alkmaar", "image": "https://onpointkoerier.nl/logo.png", "url": "https://onpointkoerier.nl/werkgebied/alkmaar", "telephone": "0630037257", "areaServed": { "@type": "City", "name": "Alkmaar" } }) }} />
      {/* SECTIE 1 - HERO */}
