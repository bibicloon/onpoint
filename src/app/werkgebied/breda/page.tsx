...
export default function BredaPage() {
  return (
    <main>
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({ "@context": "https://schema.org", "@type": "CourierService", "name": "OnPoint Koeriers Breda", "image": "https://onpointkoerier.nl/logo.png", "url": "https://onpointkoerier.nl/werkgebied/breda", "telephone": "0630037257", "areaServed": { "@type": "City", "name": "Breda" } }) }} />
      {/* SECTIE 1 - HERO */}
